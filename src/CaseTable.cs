// Generated by build/extract_case_table.py from the reference
// implementation at github.com/anthay/ELIZA. Do not edit by hand.
//
// ELIZA uppercases everything, and which table it uppercases with is
// visible behaviour: a keyword only matches if the input folds to the same
// letters. .NET disagrees with this table in both directions -- Greek final
// sigma is the clearest case -- so the table travels with the engine.

namespace ElizaApp
{
    static class CaseTable
    {
        // Lower, upper, lower, upper, ascending by the lower code point.
        public static readonly uint[] LowerUpper = {
            ...
            0x03F0, 0x039A, 0x03F1, 0x03A1, 0x03F2, 0x03F9, 0x03F5, 0x0395,
            ...
            0x0585, 0x0555, 0x0586, 0x0556, 0x1D7D, 0x2C63, 0x1E01, 0x1E00,
            ...
            0x2CE3, 0x2CE2, 0x2D00, 0x10A0, 0x2D01, 0x10A1, 0x2D02, 0x10A2,
            ...
            0x2D23, 0x10C3, 0x2D24, 0x10C4, 0x2D25, 0x10C5, 0xFF41, 0xFF21,
        ...
        public static uint Upper(uint c)
        {
            int last = LowerUpper.Length - 2, i = 0;
            while (i < last && c > LowerUpper[i]) i += 2;
            return c == LowerUpper[i] ? LowerUpper[i + 1] : c;
        }
    }
}
